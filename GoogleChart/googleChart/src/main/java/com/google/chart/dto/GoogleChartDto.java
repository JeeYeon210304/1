...
public class GoogleChartDto {
	...
	public GoogleChartDto(int chartNo, String chartId, String chartTitle, String chartContent, String chartreadingtime,
	...
	public String toString() {
		return "GoogleChartDto [chartNo=" + chartNo + ", chartId=" + chartId + ", chartTitle=" + chartTitle
				+ ", chartContent=" + chartContent + ", chartreadingtime=" + chartreadingtime + ", chartMdate="
				+ chartMdate + ", chartRegDate=" + chartRegDate + ", chartIsbn=" + chartIsbn + "]";
	}
